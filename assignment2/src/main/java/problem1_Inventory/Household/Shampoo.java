/**
 * Represents a Shampoo object under the Household abstract class
 *
 * @author Cody Cao
 */
public class Shampoo extends Household {
  ...
  /**
   * Creates a new Shampoo object. This product does not have any age restriction, and the
   ...
   */
  protected Shampoo(String manufacturer, String productName, double price, int numUnit) {
    super(manufacturer, productName, price, numUnit);
  }

  /**
   * Creates a new Shampoo object. This product has a minimum age restriction.
   *
   * @param manufacturer a String represents the manufacturer's name
   * @param productName  a String represents the product's name
   * @param price        a double represents the product's price
   ...
   * @param numUnit      an int represents the number of units in an individual package
   */
  protected Shampoo(String manufacturer, String productName, double price, int minimumAge,
      int numUnit) {
