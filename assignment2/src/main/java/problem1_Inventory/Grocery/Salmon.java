/**
 * Represents a Salmon object under the Grocery abstract class
 *
 * @author Cody Cao
 */
public class Salmon extends Grocery {
  ...
  /**
   * Creates a new Salmon object. This product does not have any age restriction, and the minimumAge
   * will be set to 0
   *
   ...
   */
  protected Salmon(String manufacturer, String productName, double price, double weight) {
    super(manufacturer, productName, price, weight);
  }

  /**
   * Creates a new Salmon object. This product has a minimum age restriction
   *
   * @param manufacturer a String represents the manufacturer's name
   * @param productName  a String represents the product's name
   ...
   * @param weight       a double represents the weight of the product
   */
  protected Salmon(String manufacturer, String productName, double price, int minimumAge,
      double weight) {
