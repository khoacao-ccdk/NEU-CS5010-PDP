...
/**
 * Represents the Letter template handler
 *
 * @author Cody Cao
 */
public class LetterTemplateHandler implements TemplateHandler {

  /**
   * Format of the output letter file name
   */
  public static final String OUTPUT_FILE_NAME = "%s_%s_letter.txt";
  /**
   ...
   */
  public static final String ERROR_CANNOT_CREATE = "Could not create letters";
  private String template;

  /**
   * Constructs a new LetterTemplateHandler object
   */
  public LetterTemplateHandler() {
    this.template = null;
  }

  /**
   * Retrieve the letter template from a file name
   *
  ...
  /**
   * Generates a letter for a customer
   *
  ...
  /**
   * @param o another LetterTemplateHandler object
  ...
  public boolean equals(Object o) {
    ...
    LetterTemplateHandler that = (LetterTemplateHandler) o;
