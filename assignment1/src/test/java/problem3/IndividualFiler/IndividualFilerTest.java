...
class IndividualFilerTest {
  ...
  @Test
  void calculateTaxes(){
    assertEquals(35815, f.calculateTaxes());
  }

  @Test
  void calculateTaxesWithMortgageDeduction(){
    f.setEarning(200000);
    assertEquals(25840, f.calculateTaxes());
  }

  @Test
  void calculateTaxesLessThanThreshold(){
    f.setEarning(100000);
    assertEquals(5400, f.calculateTaxes());
  }

//  @Test
//  void calculateTaxesLargeRetirementAndHealth(){
//    f.setEarning(100000);
//    f.setRetirementContribution(40000);
//    f.setRetirementContribution(40000);
//    assertEquals(4350, f.calculateTaxes());
//  }
}