...
public class MarriedSeparate extends GroupFiler {
  ...
  /**
   * Create a new MarriedSeparate object that holds information of the tax filer; this class is used
   * for married filers filling their taxes separately
   *
